...
def perk_categories(category):
    ...
    alley_side_perks = range(1, 4)
    dressing_room_side_perks = (1, 2, 4, 5)
    ...
    Location:
    1 = Alley side ({len(alley_side_perks)})
    2 = Dressing Room side ({len(dressing_room_side_perks)})
